...
import com.gnm.katalogfilm.util.DateFormat;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            if (!isRecordExists(id_film)) {
                ...
                contentValues.put(DatabaseContract.FilmColumns.FILM_JUDUL, judul);
                contentValues.put(DatabaseContract.FilmColumns.FILM_IMG, img);
